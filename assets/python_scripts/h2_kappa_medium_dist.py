...
ax1.plot(
    kappas,
    2 ** (-1 / 2) * (s1010 - s0101),
    label=r"$\frac{1}{\sqrt{2}}\left(\left|1010\right> - \left|0101\right>\right)$",
)
...
ax1.legend(frameon=False, loc="upper center", bbox_to_anchor=(0.5, 1.35), ncols=2)
...
plt.tight_layout()
plt.savefig("h2_kappa_medium.svg")
